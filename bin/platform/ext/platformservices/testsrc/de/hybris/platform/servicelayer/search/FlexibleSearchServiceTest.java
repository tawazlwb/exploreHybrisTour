...
public class FlexibleSearchServiceTest extends ServicelayerTransactionalTest
{
	...
	public void testSearchRangeCombos()
	{
		...
		final de.hybris.platform.jalo.SearchResult<Integer> countSR = FlexibleSearch.getInstance()
				.search("SELECT COUNT({pk}) FROM {Product}", Integer.class);
	...
	/**
	 * This method tests the usage of jalo classes vs. service layer model classes (and default java classes) for the search
	 * result class list. The same flexiblesearch statement is used for both searches and multicolumn.
	 */
	@Test
	 ...
	 * all object as {@link ItemModel},{@link EnumerationValueModel} instances.
	 */
	@Test
	...
	/**
	 * If explicitly declared expected class as implementation of {@link de.hybris.platform.core.HybrisEnumValue} instances
