...
public class MediaManagerTest extends HybrisJUnit4TransactionalTest
{
	...
	{
		final Collection<String> securedFolders = Registry.getApplicationContext()
				.getBean("mediaStorageConfigService", MediaStorageConfigService.class).getSecuredFolders();
