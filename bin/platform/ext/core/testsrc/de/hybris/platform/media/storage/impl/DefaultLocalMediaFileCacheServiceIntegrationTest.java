...
public class DefaultLocalMediaFileCacheServiceIntegrationTest extends ServicelayerBaseTest
{
	...
	public void setUp() throws Exception
	{
		...
		given(streamGetterWithSpecialCharacters.getStream(folderConfig,
				MEDIA_LOCATION_IN_STORAGE_WITH_SPECIAL_CHARACTERS_AFTER_ENCODING)).willReturn(inputStream);
	...
	public void shouldNotThrowExceptionsWhenLocationWithSpecialCharacters() throws IOException
	{
		try (InputStream stream1 = localMediaFileCacheService.storeOrGetAsStream(folderConfig,
				MEDIA_LOCATION_IN_STORAGE_WITH_SPECIAL_CHARACTERS_AFTER_ENCODING, streamGetterWithSpecialCharacters))
		{
